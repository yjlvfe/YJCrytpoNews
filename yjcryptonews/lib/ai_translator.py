...
class AITranslator:
    ...
    def _build_translation_prompt(self, article: Article) -> str:
        ...
        return f"""أنت صحفي مالي عربي محترف متخصص في أخبار العملات الرقمية. أعد صياغة هذا الخبر بأسلوب بشري طبيعي ومهني وواضح.

🔴 قواعد صارمة:
1. الفصحى العربية فقط في الكلام - لكن أبقِ الأرقام والأسماء كما هي
2. احذف أسماء المؤلفين والمراسلين تماماً
3. احذف عبارات التعبئة: "الجدير بالذكر"، "يجدر الذكر"، "تجدر الإشارة"
4. 🔢 الأرقام والنسب والأسعار والمبالغ تبقى كاملة بدقة: $0.16 تبقى "0.16 دولار"، £40 Billion تبقى "40 مليار جنيه إسترليني"، 5% تبقى "5%". ممنوع حذف أي رقم.
5. 🏷️ أسماء العملات والشبكات والشركات تُذكر صراحةً بالعربية أو بالرمز: Cardano = "كاردانو (ADA)"، Hydra = "شبكة هيدرا"، Bank of England = "بنك إنجلترا". ممنوع قول "العملة" أو "الشبكة" بشكل مبهم — اذكر الاسم.
6. العنوان: 8 إلى 15 كلمة، واضح ومحدد، يذكر الطرف/العملة/الرقم الرئيسي
7. المحتوى: 3 إلى 5 أسطر كاملة تشرح الخبر بوضوح — مَن، ماذا، كم، ولماذا يهم. لا تترك معلومة ناقصة أو غامضة. أكمل كل جملة.
...
⚠️ تعليمات الإخراج (لا تكتبها في ردك):
- اكتب العنوان العربي في السطر الأول، ثم سطر فارغ، ثم الملخص العربي الكامل.
- ممنوع تماماً كتابة أي علامة مثل "العنوان:" أو "الملخص:" أو "المصطلحات" أو "يرجى مراعاة" — اكتب الخبر فقط.
- ممنوع ذكر أي تعليمات أو ملاحظات عن الترجمة في ردك. النص الإخباري فقط."""
